...
print(ArbolesMontecarlo(semillas, param_basicos))
#------------------------------------------------------------------------------
#------------------------------------------------------------------------------
...
#print(dataset[clase_binaria==TRUE])
#tail(dataset)
...
archivo_salida <- "/home/vielma_jesused182/Documents/Gridsearch_doc/grid_binario_002.txt
"
    ...
    for (vcp in c(-0.3, -0.4, -0.5, 0.3)) {
      for (vmin_bucket in c(75, 80, 85, 90, 95, 100, 105, 110, 115)) {
        ...
        cat(
          ...
          vmin_split, "\t",
          vmin_bucket, "\t",
          vcp, "\t",  # Agregar el valor de vcp aquí ganancia_promedio, 
