...
PARAM <- list()
PARAM$experimento <- "FE6310-competencia_001-lag1-2"

PARAM$exp_input <- "DR6210-competencia_001"
...
PARAM$RandomForest$semilla <- 143821 # cambiar por la propia semilla
...
PARAM$CanaritosAsesinos$semilla <- 168977
