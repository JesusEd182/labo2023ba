...
PARAM <- list()
PARAM$experimento <- "TS6410_008_SP_001"

PARAM$exp_input <- "FE6310_008_SP_001"
...
PARAM$train$semilla <- c(200003, 280001, 300007 ,143821, 168977) # cambiar por su propia semilla  !!!
