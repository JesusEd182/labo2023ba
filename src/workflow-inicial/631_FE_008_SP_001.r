...
PARAM <- list()
PARAM$experimento <- "FE6310_008_SP_001"

PARAM$exp_input <- "DR6210_008_SP_001"
...
PARAM$RandomForest$semilla <- c(200003, 280001, 300007 ,143821, 168977) # cambiar por la propia semilla
...
PARAM$CanaritosAsesinos$semilla <- c(200003, 280001, 300007 ,143821, 168977)
