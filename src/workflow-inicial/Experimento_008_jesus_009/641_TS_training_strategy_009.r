...
PARAM <- list()
PARAM$experimento <- "TS6410-J009"

PARAM$exp_input <- "FE6310-J008"
...
PARAM$train$training <- c(
  202102, 202101, 202012, 202011, 202010, 202009, 202008, 202002, 202001, 201912, 201911,
...
PARAM$train$semilla <- 143821 # cambiar por su propia semilla  !!!
